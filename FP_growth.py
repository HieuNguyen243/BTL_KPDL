class TreeNode:
    def __init__(self, name_value, num_occur, parent_node):
        ...
        self.count = num_occur  # Đã sửa: Lưu giá trị đếm vào thuộc tính count
        self.node_link = None
        self.parent = parent_node
        self.children = {}

    def inc(self, num_occur):
        self.count += num_occur  # Đã sửa: Tăng đúng thuộc tính count
...
# Đã sửa: Thêm max_len=3 và điều kiện dừng đệ quy để chống tràn RAM
def mine_fp_tree(current_fp_tree, header_table, min_support, current_prefix, frequent_itemsets, max_len=3):
    # Điều kiện dừng: Nếu tổ hợp hiện tại đã đạt độ dài tối đa thì không đào sâu thêm nữa
    ...
    for current_item in items_sorted_by_freq:
        ...
        # Chỉ tạo cây điều kiện (đào sâu) nếu tổ hợp mới vẫn nhỏ hơn max_len
